node{
    ...
    stage('git code checkout'){
        try{
            ...
            ${BUILD_URL}''', subject: 'Job ${JOB_NAME} ${BUILD_NUMBER} is failed', to: 'vipinms@icloud.com'
        }
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} login -u vipinms90 -p ${dockerHubPassword}"
        sh "${dockerCMD} push vipinms90/insure-me:${tagName}"
